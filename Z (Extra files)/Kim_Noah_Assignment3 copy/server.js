...
var cookieParser = require('cookie-parser'); // Require cookie-paser
var session = require('express-session'); // Require express-session mod.
const nodemailer = require("nodemailer"); // Require nodemailer mod.
app.use(cookieParser()); // Middleware
// var user_info_file = './user_data.json'; // Set variable user_data file to user_info_file
